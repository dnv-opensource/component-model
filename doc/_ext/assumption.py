...
def purge_assumptions(app, env, docname):
    ...
    env.assumption_all_assumptions = [assumption for assumption in env.assumption_all_assumptions
                          if assumption['docname'] != docname]
    ...
    for node in doctree.findall(assumptionlist):
        ...
        for assumption_info in env.assumption_all_assumptions:
            ...
            description = (
                ...
                (filename, assumption_info['lineno']))
            ...
            newnode['refuri'] = app.builder.get_relative_uri(
                fromdocname, assumption_info['docname'])
