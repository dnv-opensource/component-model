...
def purge_specs(app, env, docname):
    ...
    env.spec_all_specs = [spec for spec in env.spec_all_specs
                          if spec['docname'] != docname]
...
def setup(app):
    app.add_config_value('spec_include_specs', True, 'html')
